...
levels=data.frame(Var1=c("High School","Freshmen","Sophomore","Junior","Senior"),
                  Freq=c(1,9,10,16,10))
par(mar = c(5, 10, 4, 2))
barplot(majors$Freq,
...
- **Is there a required textbook?**
  - Yes -- it's free. You can find it in Canvas or the course website
:::
...
::::: columns
::: {.column width="30%"}
![](images/lec-1/aac-website.png){fig-alt="QR code for AAC" fig-align="center" width="300"}

<div style="text-align: center;">
  <strong>Academic Achievement Center</strong>
</div>
...
::: {.column width="70%"}
-   Hale Library
-   Drop-in or appointment tutoring
-   Student peers with classroom experience
-   All subjects (including writing)
-   Learning is not without pain
    - Pain shouldn't be the focus
:::
:::::
